...
const brandContent = {
  deleon: {
    ...
    summary: 'DELEON ENTERPRISES has grown from a land stewardship practice into a luxury agricultural and property group united by stewardship, long-view investing, and a belief in responsible growth.',
    story: [
      ...
      'Our VISION is to anchor a modern African luxury ecosystem where land is not merely acquired but respected, developed and preserved with precision.'
    ],
    gallery: [
      ...
      { src: 'https://images.unsplash.com/photo-1521295121783-8a321d551ad2?auto=format&fit=crop&w=900&q=80', caption: 'Luxury agricultural estates' },
