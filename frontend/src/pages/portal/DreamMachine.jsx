...
export default function DreamMachine() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#F2F0EB] text-[#111111]">
      ...
      <div className="flex min-h-screen items-center justify-center px-4 pt-24 sm:px-6 lg:px-8">
        <div className="relative w-full max-w-[1000px] lg:max-w-[1300px] lg:h-[80vh]">
          <button
            type="button"
            onClick={prev}
